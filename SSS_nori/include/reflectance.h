...
namespace Reflectance {
	...
	/**
	 * \brief Computes the Henyey-Greenstein phase function value
	 *
	 * \param cosTheta
	 *      The cosine of the scattering angle between the incoming and outgoing directions
	 * \param g
	 *      The anisotropy parameter (-1 for backward scattering, 0 for isotropic scattering, +1 for forward scattering)
	 * \return
	 *      The value of the phase function
	 */
	extern float henyeyGreenstein(float cosTheta, float g);
};
